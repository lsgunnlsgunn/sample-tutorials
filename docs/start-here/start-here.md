...
<h4 class="summary">Let's start your DC/OS tour by creating a cluster</h4> 
...
1. Type your administrative user name and password, then click **Log in**.
    ...
    ![Log in to the administrative console](../img/sample-login.png)

    If the connection is successful, the DC/OS dashboard is displayed.

    ![DC/OS dashboard in the administrative console](../img/Sample-dashboard.png)
