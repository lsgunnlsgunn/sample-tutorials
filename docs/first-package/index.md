...
<h4 class="summary">Illustrates how to install a sample service package</h4>
...
1. Type a search string to locate the package you want to install.
    ...
    ![Search for packages in the Catalog](../img/tutorial-redis-search.png)
...
1. Click **Redis** and verify the CPU and memory settings.
    ...
    ![Redis configuration settings](../img/tutorial-redis-config.png)

1. Click **Review & Run** to verify your Redis configuration, then click **Run Service**.

    ![Redis configuration settings](../img/tutorial-redis-run.png)

1. Click **Open Service** to view the status of the Redis deployment.

    ![Redis configuration settings](../img/tutorial-redis-open-service.png)
-->
...
1. Verify the Status column for Redis displays Running.
    ...
    ![Checking the Redis service status](../img/tutorial-redis-status.png)

1. Click the service name to display task-level details.

    ![Checking the Redis details](../img/tutorial-redis-details.png)
...
1. Open a secure shell (SSH) session on the cluster node where the Redis service is running.
