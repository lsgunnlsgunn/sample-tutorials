...
<h4 class="summary"> Provides step-by-step instructions to introduce basic DC/OS cluster tasks</h4>
---
...
Ready to get started? Let's [create your first cluster](../start-here/start-here/)...
