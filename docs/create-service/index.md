...
<h4 class="summary">Illustrates how to create and deploy single command or an image using container</h4>
...
1. Click **Review & Run**, then click **Run Service**.
    ...
    ![Create and run a single-command service](../img/tutorial-single-cmd-create-ui.png)

1. Click the name of your service in the **Services** view to see it running and monitor its health.

    ![Check the running service in the DC/OS console](../img/tutorial-run-cmd-service.png)
...
1.  Verify the single-command service has been successfully deployed by running the following command:
    ...
    ![Verifying your single-command services](../img/tutorial-single-cmd-verification.png)
...
1. Type the container path and image tag in the **Container Image** field.
    ...
    ![Containerized service in the DC/OS UI](../img/deploy-container-ui.png)

1.  Click **Review & Run**, then click **Run Service**.

1. Click the name of your service in the **Services** view to see it running and monitor its health.

    ![Verifying the containerized service is running](../img/tutorial-running-container.png)
...
1. Click **Logs**, then click **Error (stderr)** and **Output (stdout)** to see the logged messages and output for the containerized service.
    ...
    ![Verifying the containerized service is running](../img/container-running-ui.png)
...
![Sample output from container app](../img/tutorial-hello-dcos-output.png)
